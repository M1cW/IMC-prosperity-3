...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if "VOLCANIC_ROCK" in state.order_depths and "VOLCANIC_ROCK_VOUCHER_10000" in state.order_depths:
            ...
            # Get trading signal
            signal = self.get_voucher_trade_signal(
            ...
            if signal == 'buy' and state.order_depths["VOLCANIC_ROCK_VOUCHER_10000"].sell_orders:
                if position + 1 <= self.LIMIT["VOLCANIC_ROCK_VOUCHER_10000"]:
                    ...
                    result["VOLCANIC_ROCK_VOUCHER_10000"].append(Order("VOLCANIC_ROCK_VOUCHER_10000", best_ask, 1))
                ...
                if position - 1 >= -self.LIMIT["VOLCANIC_ROCK_VOUCHER_10000"]:
                    ...
                    if "VOLCANIC_ROCK_VOUCHER_10000" not in result:
                        result["VOLCANIC_ROCK_VOUCHER_10000"] = []
                    result["VOLCANIC_ROCK_VOUCHER_10000"].append(Order("VOLCANIC_ROCK_VOUCHER_10000", best_bid, -1))
